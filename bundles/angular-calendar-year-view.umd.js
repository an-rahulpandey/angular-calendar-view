(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('lodash/cloneDeep'), require('@angular/platform-browser'), require('ngx-bootstrap/popover'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('angular-calendar-year-view', ['exports', '@angular/core', 'lodash/cloneDeep', '@angular/platform-browser', 'ngx-bootstrap/popover', '@angular/common'], factory) :
    (global = global || self, factory(global['angular-calendar-year-view'] = {}, global.ng.core, global.cloneDeep__default, global.ng.platformBrowser, global.popover, global.ng.common));
}(this, function (exports, core, cloneDeep__default, platformBrowser, popover, common) { 'use strict';

    var cloneDeep__default__default = 'default' in cloneDeep__default ? cloneDeep__default['default'] : cloneDeep__default;
     ...
     */
    /** @type {?} */
    var clone = cloneDeep__default__default || cloneDeep__default;
    ...
    var AngularCalendarYearViewModule = /** @class */ (function () {
        ...
        function () {
            return {
                ...
                providers: [
                    popover.PopoverModule.forRoot().providers
                ]
            };
        };
